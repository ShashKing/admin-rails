...
class StoreSettingDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    ...
    vat_number: Field::String.with_options(searchable: false),
    phone: Field::String.with_options(searchable: false),
    email: Field::String,
    registered_number: Field::String.with_options(searchable: false),
